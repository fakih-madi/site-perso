                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6">
                        <div class="header-content-right">
                            <h4 class="sub-title">Hello, je suis</h4>
                            <h1 class="title">Madi Fakih</h1>
                            <p>Développeur web & entrepreneur</p>
                            <a class="main-btn" href="#work">Voir mes projets</a>
                        ...
                        <div class="col-lg-12">
                            <div class="header-social-icon">
                                <ul>
                                    ...
                                    <!--<li><a href="#"><i class="lni-twitter-original"></i></a>-->
                                    <!--<li><a href="#"><i class="lni-behance-original"></i></a></li>-->
                                    <li><a href="https://www.linkedin.com/in/fakih-madi-5967b2160"><i class="lni-linkedin-original"></i></a></li>
                                </ul>
                            </div> <!-- header social -->
                        </div>
                    </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content mt-50">
                        <h5 class="about-title">Je suis Fakih</h5>
                        <p>Je suis actuellement en formation RNCP développeur web et web mobile à la plateforme_.</p>
                        <ul class="clearfix">
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Née le :</span> 3 décembre 1997 à Marseille</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Email:</span> fakih.madi@laplateforme.io</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                                <div class="single-info d-flex align-items-center">
                                    ...
                                    <div class="info-text">
                                        <p><span>Téléphone:</span> 0768386219</p>
                                    </div>
                                </div> <!-- single info -->
                            </li>
                            <li>
                ...
                <div class="col-xl-5 offset-xl-1 col-lg-6">
                    <div class="about-skills pt-25">
                        ...
                        <div class="skill-item mt-25">
                            <div class="skill-header">
                                <h6 class="skill-title">Shopify</h6>
                                <div class="skill-percentage">
                                    <div class="count-box counted">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center pb-30">
                        ...
                        <p>Retrouvez-ici les différents que je propose.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-service text-center mt-30">
                        ...
                        <div class="service-content">
                            <h4 class="service-title"><a href="#">design graphique</a></h4>
                            <p> Design pour maillots de sports (rugby, football, basket-ball...).</p>
                        </div>
                    </div> <!-- single service -->
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-service text-center mt-30">
                        ...
                        <div class="service-content">
                            <h4 class="service-title"><a href="#">Réseaux sociaux</a></h4>
                            <p>Création de support de communiction pour les réseaux sociaux.</p>
                        </div>
                    </div> <!-- single service -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title pb-25">
                        ...
                        <p>Retrouvez ici mes derniers projets.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-work text-center mt-30">
                        <div class="work-image">
                            <img src="assets/images/work/w-1.png" alt="projet laplateforme_ Marseille Fakih">
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center pb-25">
                        ...
                        <p>Retrouvez ci-dessous mes moyens de contact.</p>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="contact-box text-center mt-30">
                        ...
                        <div class="contact-content">
                            <h6 class="contact-title">Ville</h6>
                            <p>Marseille</p>
                        </div>
                    </div> <!-- contact box -->
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="contact-box text-center mt-30">
                        ...
                        <div class="contact-content">
                            ...
                            <p>fakih.madi@laplateforme.io</p>
                        </div>
                    </div> <!-- contact box -->
                </div>
            </div> <!-- row -->
